...
exports.GitLoader = nunjucks.Loader.extend({
    ...
    getSource: function(name, cb) {
        ...
        if (env.github) {
            ...
            github.get_github_source(app, user, repo, branch, name, function(e,src) {
                if (e) {
                    return github.get_github_source(app, env.base_user, env.base_repo_name, 'master', name, function (e, src) {
